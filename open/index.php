...
<head>
    ...
    <script>
        ...
        Global.apiMap = {"api/index/apps.php":"apps" , "api/todo.php<?php echo '?'.$_SERVER["QUERY_STRING"]; ?>":"todos","api/me/processes/doing?limit=%s&start=%s&keyword=%s":"doings"
...
//			if(length < pageSize) return;
    ...
    function toGetHotApps(entities){
        ...
        $.ajax({
            ...
            url:Global.contentpath+"api/index/apps2.php",
            dataType:"json",
    ...
    $(document).ready(function() {
        ...
        //$.extend( Global.apiMap , {"api/me/processes/merge" : "myApplies","api/cc.php?limit=100000&start=%s&keyword=%s":"ccs",	"api/cc.php?limit=%s&start=%s&keyword=%s":"ccs1","apps/recommended?domain=qziedu.cn":"apps","api/index/apps":"apps1"});
