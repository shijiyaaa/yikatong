...
<head>
    ...
    <script>
        ...
        Global.apiMap = {"api/me/apps":"apps" , "api/todo.php<?php echo '?'.$_SERVER["QUERY_STRING"]; ?>":"todos","api/me/processes/doing":"doings"
            , "api/done.php<?php echo '?'.$_SERVER["QUERY_STRING"]; ?>":"dones","api/me/processes/completed?limit=%s&start=%s&keyword=%s":"completeds" ,
